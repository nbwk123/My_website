...
<p class="case-eyebrow">AI-assisted parent-child improvisational storytelling system</p>

<h1 class="costory-wordmark costory-wordmark-hero">COSTORY</h1>

<p class="case-lead">COSTORY uses a physical prop and AI-assisted guidance to provide plot prompts and feedback, helping parents and children co-create stories through higher-quality interaction.</p>
...
<img class="case-cover-image" src="../../../assets/costory-case/cover.jpg" alt="COSTORY project cover">

</section>

<section class="case-dark-intro" markdown="1">
<p class="case-section-label">Core Question</p>

## How can we reduce the risk of storytelling breakdown without interrupting parent-child co-creation?

<p>COSTORY does not use AI to tell stories for children. Instead, when parent-child interaction weakens, the story gets stuck, or the next direction becomes unclear, it provides lightweight prompts, scene feedback, and story organization. The system aims to shift the screen from a controller into an assistant, bringing physical participation, language expression, and emotional response back to the center of parent-child interaction.</p>
</section>

<div class="case-stat-grid" markdown="1">
<section class="case-stat" markdown="1">
<strong>78.6%</strong>
<span>Young children spend more than 1 hour on screens each day</span>
</section>
<section class="case-stat" markdown="1">
<strong>53.0%</strong>
<span>Young children spend more than 2 hours on screens each day</span>
</section>
<section class="case-stat" markdown="1">
<strong>3 Dimensions</strong>
<span>Language interaction, physical participation, and emotional response form high-quality parent-child interaction</span>
</section>
</div>

<section class="case-section" markdown="1">
<div markdown="1">
<p class="case-section-label">01 / Problem Finding</p>
...
<img src="../../../assets/costory-case/problem.jpg" alt="Problem finding and parent-child interaction analysis">
...
<div markdown="1">
<p class="case-section-label">02 / User Insight</p>
...
<figure class="case-figure" markdown="1">
<img src="../../../assets/costory-case/research.jpg" alt="User research and storytelling stagnation journey">
...
<p class="case-section-label">03 / Design Opportunities</p>
...
<img class="case-wide-image" src="../../../assets/costory-case/opportunity.jpg" alt="COSTORY design opportunities">
</section>

<section class="case-dark-intro case-flow" markdown="1">
<p class="case-section-label">04 / System Plan</p>
...
<img src="../../../assets/costory-case/flow.jpg" alt="COSTORY system flow">
...
<section class="case-section" markdown="1">
<div markdown="1">
<p class="case-section-label">05 / Hardware Design</p>
...
<figure class="case-figure" markdown="1">
<img src="../../../assets/costory-case/hardware.jpg" alt="COSTORY hardware design">
...
<section class="case-section case-section-flip" markdown="1">
<div markdown="1">
<p class="case-section-label">06 / Software Design</p>
...
<figure class="case-figure" markdown="1">
<img src="../../../assets/costory-case/software-screens.jpg" alt="COSTORY software support interface">
...
<article markdown="1">
<img src="../../../assets/costory-case/software-role.jpg" alt="COSTORY IP character design">
...
<article markdown="1">
<img src="../../../assets/costory-case/software-context.jpg" alt="COSTORY context introduction interface">
### Context Introduction
...
<article markdown="1">
<img src="../../../assets/costory-case/software-ai.jpg" alt="COSTORY AI-assisted guidance">
### Light AI Prompts
...
<article markdown="1">
<img src="../../../assets/costory-case/story-edit.jpg" alt="COSTORY story organization and expression adjustment">
### Story Organization
...
<section class="case-dark-intro" markdown="1">
<p class="case-section-label">07 / Prototype Validation</p>
...
<article markdown="1">
<img src="../../../assets/costory-case/prototype-hardware.jpg" alt="Hardware action recognition prototype">
### Action Recognition
...
<article markdown="1">
<img src="../../../assets/costory-case/prototype-scene.jpg" alt="Narrative scene generation prototype">
### Scene Generation
Locations and change events are combined to generate scenes so that image and text semantics remain consistent.
</article>
<article markdown="1">
<img src="../../../assets/costory-case/prototype-ai.jpg" alt="AI-assisted guidance prototype">
### Development Direction
AI generates directions around character, scene, and event instead of giving a complete answer directly.
</article>
<article markdown="1">
<img src="../../../assets/costory-case/prototype-story.jpg" alt="Complete story generation prototype">
### Complete Story
...
<p class="case-section-label">Project Reflection</p>
